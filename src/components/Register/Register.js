...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        ...
        fetch("https://stormy-ocean-88968.herokuapp.com/register", {
            method: 'post',
                ...
                <div className="measure">
                    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                        ...
                        <div className="mt3">
                            ...
                            <input onChange = {this.onNameChange} className="bold-lettering pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="name" id="name" />
                        </div>
                        <div className="mt3">
